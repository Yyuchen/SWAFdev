...
export class JeuxPage implements OnInit {
  ...
  Validation1(){
    ...
    if(this.Resp.Q2 == 2 ){
      ...
      if(this.ComptResultat==1){
        this.ComptResultat=2;
      }else{
        this.ComptResultat=1;
      }
    }
    ...
    if(this.Resp.Q3 == 2 ){
      ...
      if(this.ComptResultat==2){
        this.ComptResultat=3;
      }else if(this.ComptResultat==1){
        this.ComptResultat=2;
      }else{
        this.ComptResultat=1;
      }
    ...
    if(this.Resp.Q4 == 2 ){
      ...
      if(this.ComptResultat==3){
        this.ComptResultat=4;
      }else if(this.ComptResultat==2){
        this.ComptResultat=3;
      }else if(this.ComptResultat==1){
        this.ComptResultat=2;
      }else{
  ...
  Validation5(){
    if(this.Resp.Q5 == 4 ){
      ...
      if(this.ComptResultat==4){
        this.ComptResultat=5;
      }else if(this.ComptResultat==3){
        this.ComptResultat=4;
      }else if(this.ComptResultat==2){
        this.ComptResultat=3;
      }else if(this.ComptResultat==1){
    ...
    if(this.Resp.Q6 == 3 ){
      ...
      if(this.ComptResultat==5){
        this.ComptResultat=6;
      }else if(this.ComptResultat==4){
        this.ComptResultat=5;
      }else if(this.ComptResultat==3){
        this.ComptResultat=4;
      }else if(this.ComptResultat==2){
    ...
    if(this.Resp.Q7 == 2 ){
      ...
      if(this.ComptResultat==6){
        this.ComptResultat=7;
      }else if(this.ComptResultat==5){
        this.ComptResultat=6;
      }else if(this.ComptResultat==4){
        this.ComptResultat=5;
      }else if(this.ComptResultat==3){
    ...
    if(this.Resp.Q8 == 3 ){
      ...
      if(this.ComptResultat==7){
        this.ComptResultat=8;
      }else if(this.ComptResultat==6){
        this.ComptResultat=7;
      }else if(this.ComptResultat==5){
        this.ComptResultat=6;
      }else if(this.ComptResultat==4){
    ...
    if(this.Resp.Q9 == 1 ){
      ...
      if(this.ComptResultat==8){
        this.ComptResultat=9;
      }else if(this.ComptResultat==7){
        this.ComptResultat=8;
      }else if(this.ComptResultat==6){
        this.ComptResultat=7;
      }else if(this.ComptResultat==5){
    ...
    if(this.Resp.Q10 == 3 ){
      ...
      if(this.ComptResultat==9){
        this.ComptResultat=10;
      }else if(this.ComptResultat==8){
        this.ComptResultat=9;
      }else if(this.ComptResultat==7){
        this.ComptResultat=8;
      }else if(this.ComptResultat==6){
    ...
    if(this.Resp.Q11 == 4 ){
      ...
      if(this.ComptResultat==10){
        this.ComptResultat=11;
      }else if(this.ComptResultat==9){
        this.ComptResultat=10;
      }else if(this.ComptResultat==8){
        this.ComptResultat=9;
      }else if(this.ComptResultat==7){
    ...
    if(this.Resp.Q12 == 1 ){
      ...
      if(this.ComptResultat==11){
        this.ComptResultat=12;
      }else if(this.ComptResultat==10){
        this.ComptResultat=11;
      }else if(this.ComptResultat==9){
        this.ComptResultat=10;
      }else if(this.ComptResultat==8){
    ...
    if(this.Resp.Q13 == 1 ){
      ...
      if(this.ComptResultat==12){
        this.ComptResultat=13;
      }else if(this.ComptResultat==11){
        this.ComptResultat=12;
      }else if(this.ComptResultat==10){
        this.ComptResultat=11;
      }else if(this.ComptResultat==9){
