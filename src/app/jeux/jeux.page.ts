...
export class JeuxPage implements OnInit {
  ...
  Validation1(){
    if(this.Resp.Q1 == 3 ){
      this.ComptResultat++;
      this.Resp.Q1Bool= " Bonne réponse : 1L.";
    }
    else{
      this.Resp.Q1Bool= " Bonne réponse : 1L.";
    }
    ...
    if(this.Resp.Q2 == 2 ){
      this.ComptResultat++;
      this.Resp.Q2Bool=" Bonne réponse : Non.   Justification : L’eau apporté par les fruits et légumes ne suffit absolument pas à vous hydrater convenablement.";
    }
    else{
      this.Resp.Q2Bool=" Bonne réponse : Non.   Justification : L’eau apporté par les fruits et légumes ne suffit absolument pas à vous hydrater convenablement.";
    }
    ...
    if(this.Resp.Q4 == 2 ){
      this.ComptResultat++;
      this.Resp.Q4Bool= " Bonne réponse : Faux.   Justification : Les seniors doivent boire suffisamment, car leur sensation de soif est diminuée. Boire 1,5 l d’eau par jour permet une bonne hydratation et lutte efficacement contre les transits paresseux qui touchent un quart des personnes âgées";
    }else{
      this.Resp.Q4Bool= " Bonne réponse : Faux.   Justification : Les seniors doivent boire suffisamment, car leur sensation de soif est diminuée. Boire 1,5 l d’eau par jour permet une bonne hydratation et lutte efficacement contre les transits paresseux qui touchent un quart des personnes âgées";
    }
  }
  Validation5(){
    ...
    if(this.Resp.Q7 == 2 ){
      this.ComptResultat++;
      this.Resp.Q7Bool= " Bonne réponse : Votre poids, taille et vos activités sportives.   Justification : En effet la consommation en eau de chaque individu et propre à son poids, sa taille et ses activités sportives ou professionnelles.";
    }
    else{
      this.Resp.Q7Bool= " Bonne réponse : Votre poids, taille et vos activités sportives.   Justification : En effet la consommation en eau de chaque individu et propre à son poids, sa taille et ses activités sportives ou professionnelles.";
    }}
    ...
    if(this.Resp.Q9 == 1 ){
      this.ComptResultat++;
      this.Resp.Q9Bool= " Bonne réponse: A.   Justification : Le froid <congèle> les germes qui ne peuvent plus se multiplier. A la décongélation, les bactéries se réveillent et se développent à vive allure, créant (10x plus) de nouvelles bactéries qui -elles aussi- résistent au froid.";
    }else{
      this.Resp.Q9Bool= " Bonne réponse: A.   Justification : Le froid <congèle> les germes qui ne peuvent plus se multiplier. A la décongélation, les bactéries se réveillent et se développent à vive allure, créant (10x plus) de nouvelles bactéries qui -elles aussi- résistent au froid.";
    }
  }
    ...
    if(this.Resp.Q10 == 3 ){
      this.ComptResultat++;
      this.Resp.Q10Bool= " Bonne réponse: C.   Justification : Pulvérisé sur le sol, 3% environ de pesticides sont absorbés par la plante. Le reste passe dans les particules du sol et descend -en partie- dans les eaux d'infiltration. A l'air libre, en aérosol, certaines particules peuvent aller jusqu'a 5000 km. L'usage facile et rapide des pesticides s'est développé depuis 1939, mais la persistance et l'intensité de son utilisation ont conduit de nombreuses espèces à devenir résistantes…";
    }
    else{
      this.Resp.Q10Bool= " Bonne réponse: C.   Justification : Pulvérisé sur le sol, 3% environ de pesticides sont absorbés par la plante. Le reste passe dans les particules du sol et descend -en partie- dans les eaux d'infiltration. A l'air libre, en aérosol, certaines particules peuvent aller jusqu'a 5000 km. L'usage facile et rapide des pesticides s'est développé depuis 1939, mais la persistance et l'intensité de son utilisation ont conduit de nombreuses espèces à devenir résistantes…";
    }}
